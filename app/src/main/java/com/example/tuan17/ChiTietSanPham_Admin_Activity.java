...
//        btnaddcart = findViewById(R.id.btnaddcart);
        ...
        if (tendn != null) {
            ...
            Intent intent = new Intent(ChiTietSanPham_Admin_Activity.this, Login_Activity.class);
...
//                Toast.makeText(ChiTietSanPham_Admin_Activity.this, "Thêm vào giỏ hàng thành công", Toast.LENGTH_SHORT).show();
//            }
//        });
//        // Kiểm tra trạng thái đăng nhập và thêm sản phẩm vào giỏ hàng
...
//            } else {
//                gioHangManager.addItem(chiTietSanPham); // Gọi phương thức addItem
//                Intent intent1=new Intent(ChiTietSanPham_Admin_Activity.this,GioHang_Activity.class);
...
//        Intent a=new Intent(ChiTietSanPham_Admin_Activity.this,TimKiemSanPham_Activity.class);
//        startActivity(a);
//    }
//});
